<footer class="bg-black border-t border-base-800">
	<div class="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
	  <div class="flex justify-center gap-x-6 md:order-2">
		...
		<a href="https://github.com/flo-bit/nyx" class="text-base-400 hover:text-base-300" target="_blank">
	  ...
	  <div class="md:order-1 mt-8 flex flex-col items-center md:items-start">
