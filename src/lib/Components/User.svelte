...
{#snippet renderUser()}
	...
	<div
		class={cn(
			'size-8 overflow-hidden rounded-full border border-base-400/50 bg-base-100 transition-colors duration-100 hover:border-accent-400 dark:border-base-700 dark:bg-base-800',
			false
